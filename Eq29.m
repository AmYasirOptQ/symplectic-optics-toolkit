%% Eq. (29) of the paper https://doi.org/10.1364/JOSAA.404552
% Identity 1
...
RH = Mult(RH, Lenx(-b1/(1+d1-b1)));
RH = Mult(RH, Leny(-b2/(1+d2-b2)));
RH = Mult(RH, Prop(1));
RH = Mult(RH, Lenx(1/(2-b1)));
RH = Mult(RH, Leny(1/(2-b2)));
RH = Mult(RH, Prop(1));
RH = Mult(RH, Lenx(-b1/(1+a1-b1)));
RH = Mult(RH, Leny(-b2/(1+a2-b2))); % RHS
